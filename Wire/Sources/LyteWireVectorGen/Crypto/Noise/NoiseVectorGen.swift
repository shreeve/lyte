// Authors Vectors/noise-v1.json from two provenances.
//
// Handshake vectors are transcribed verbatim, not computed, from the two
// published Noise_IK_25519_ChaChaPoly_SHA256 sets:
// - snow (github.com/mcginty/snow) tests/vectors/snow.txt, sha256
//   69da433305fd045f6c9f01b656662a389d022688986fd39fbe7af009cd402fd3
// - cacophony (github.com/haskell-cryptography/cacophony)
//   vectors/cacophony.txt, sha256
//   3bde7c09a6f349ee11c825c50fcc02649f8f02a47c857a459206b357f9386cae
// NoiseVectorFileTests must reproduce every byte.
//
// Transport vectors (extended-counter nonce from (chan, seq), epoch
// rekey) have no published oracle; they are generated by the
// implementation under test and frozen as a regression pin.
