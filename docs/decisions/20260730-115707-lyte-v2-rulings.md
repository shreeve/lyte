...
> **Status:** Binding decision — one repository, convergence in place, always green; its directory and target-shape section is superseded by the source-layout record.
