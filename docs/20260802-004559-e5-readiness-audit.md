...
> **CLOSED (2026-08-02).** Punch items 1–4 landed (#68–#70), the owner
> soaked live on direct+native, and the flip-day checklist executed as
> PR #72 — suite 281/281 on a plain build, ldd zero libav, wire smoke
> green, the standing loop respawned onto the new binary. Tag:
> `self-hosted`.
